...
class LoadDataset(Dataset):
    def __init__(self, file_path, feature_num, model_type):
...
class LoadValTestDataset(LoadDataset):
    ...
    def __init__(self, file_path, set_name, feature_num, model_type):
        super(LoadValTestDataset, self).__init__(
            file_path, feature_num, model_type
        )
...
class LoadTrainDataset(LoadDataset):
    ...
    def __init__(
        self, file_path, feature_num, model_type, masked_imputation_task
    ):
...
class UnifiedDataLoader:
    ...
    def get_test_dataloader(self):
        self.test_dataset = LoadValTestDataset(
            self.dataset_path, "test", self.feature_num, self.model_type
        )
    ...
    def prepare_dataloader_for_imputation(self, set_name):
        data_for_imputation = LoadDataForImputation(
            self.dataset_path, set_name, self.feature_num, self.model_type
        )
